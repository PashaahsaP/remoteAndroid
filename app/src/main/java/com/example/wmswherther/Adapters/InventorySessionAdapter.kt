...
class InventorySessionAdapter(var data: List<InventorySessionItem>,
                              var recyclerView: RecyclerView,
                              var localViewModel: InventorySessionViewModel,
    ...
    override fun  onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        ...
        when (holder) {
            is InventorySessionViewHolder -> {
                ...
                holder.container.setOnLongClickListener {
                    ...
                    dialog.setButton(android.app.AlertDialog.BUTTON_POSITIVE, "Да") { _, _ ->
                        var newData: MutableList<InventorySessionItem> = mutableListOf()
                        var allData: MutableList<InventorySessionItem> = mutableListOf()
            ...
            is InventorySessionSelectedViewHolder -> {
